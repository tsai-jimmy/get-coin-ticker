...
$(function () {
  ...
  getJSON("https://poloniex.com/public?command=returnTicker").then(function (json) {
    var USDT_BTC = json.USDT_BTC.last;
    var BTC_ETH = json.BTC_ETH.last;
  ...
  getJSON("https://blockchain.info/ticker").then(function (json) {
    ...
    var BTC_TWD_buy = json.TWD.symbol + json.TWD.buy;
    var BTC_USD_buy = json.USD.symbol + json.USD.buy;

    var BTC_TWD_sell = json.TWD.symbol + json.TWD.sell;
    var BTC_USD_sell = json.USD.symbol + json.USD.sell;
  ...
  getJSON("https://www.bitoex.com/api/v1/get_rate").then(function (json) {
    console.log('我已經取回bitoex資料');
    var Bitoex_buy = json.buy;
    var Bitoex_sell = json.sell;
...
},{"core-js/fn/regexp/escape":6,"core-js/shim":328,"regenerator-runtime/runtime":4}],4:[function(require,module,exports){
(function (global){
/**
